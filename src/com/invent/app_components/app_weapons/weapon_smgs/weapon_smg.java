package com.invent.app_components.app_weapons.weapon_smgs;
...
public class weapon_smg extends weapon implements IWeapon_Action {
    public weapon_smg(String category, String name, int[] magazine_capacity, int damage, int range_of_fire, int wait_after_shot, int reload_time, int fire_mode,  String weapon_default_image, String weapon_hoverable_image) {
